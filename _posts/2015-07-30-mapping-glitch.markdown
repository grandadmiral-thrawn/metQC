---
layout: post
title: "Mapping Glitch"
date: 2015-07-30T14:21:13-07:00
---

Recently, I created an iPython Notebook to detail how we are updating Glitch. Here's a section on how we map the back-end database in order to get the information we need. Included is a short section about how columns are selected, and a suggestion for our stored procedure idea.
...
<div class="highlight"><pre><span class="kn">import</span> <span class="nn">pymssql</span>
<span class="kn">import</span> <span class="nn">datetime</span>
<span class="kn">import</span> <span class="nn">yaml</span>
<span class="kn">import</span> <span class="nn">json</span>
<span class="kn">import</span> <span class="nn">sys</span>
<span class="kn">import</span> <span class="nn">itertools</span>
<span class="kn">from</span> <span class="nn">map_glitch</span> <span class="kn">import</span> <span class="n">connect</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="kn">from</span> <span class="nn">map_glitch</span> <span class="kn">import</span> <span class="o">*</span>
</pre></div>
...
<p>After importing the requirements we connect to the database ltermeta using a basic pymssql connection: </p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">conn</span><span class="p">,</span> <span class="n">cursor</span> <span class="o">=</span> <span class="n">connect</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>We call &quot;get_entity_id&quot; for each schema in the &quot;Possible&quot; list in &quot;all_build_dict&quot;. For example, MS043, MS001, etc. Get entity_id references the entity_id, entity_filename, beginning date, and ending date in ltermeta.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">get_entity_id</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">databaseid</span><span class="p">):</span>
  <span class="sd">&quot;&quot;&quot; from entity table, get the entity id number,</span>
<span class="sd">  description, entity name, beginning and end date, etc. </span>
<span class="sd">  based on the table name we are familiar with, such as MS043</span>
<span class="sd">  &quot;&quot;&quot;</span>

  <span class="n">dbid_dict</span> <span class="o">=</span> <span class="p">{}</span>

  <span class="n">define_query</span> <span class="o">=</span> <span class="s">&quot;select entity_id, entity_file_name, entity_number, entity_title, beginning_date, ending_date from ltermeta.dbo.entity where entity_file_name like </span><span class="se">\&#39;</span><span class="s">&quot;</span> <span class="o">+</span> <span class="n">databaseid</span> <span class="o">+</span> <span class="s">&quot;%</span><span class="se">\&#39;</span><span class="s">&quot;</span>

  <span class="n">cursor</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="n">define_query</span><span class="p">)</span>

  <span class="k">for</span> <span class="n">row</span> <span class="ow">in</span> <span class="n">cursor</span><span class="p">:</span>

    <span class="k">if</span> <span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">1</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">()</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">dbid_dict</span><span class="p">:</span>
      
      <span class="n">dbid_dict</span><span class="p">[</span><span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">1</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">()]</span> <span class="o">=</span> <span class="p">{</span><span class="s">&#39;entity_id&#39;</span><span class="p">:</span><span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">0</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">(),</span> <span class="s">&#39;entity_number&#39;</span><span class="p">:</span> <span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">2</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">(),</span> <span class="s">&#39;entity_title&#39;</span><span class="p">:</span> <span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">3</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">(),</span> <span class="s">&#39;beginning_date&#39;</span><span class="p">:</span> <span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">4</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">,</span> <span class="s">&#39;ending_date&#39;</span><span class="p">:</span> <span class="nb">str</span><span class="p">(</span><span class="n">row</span><span class="p">[</span><span class="mi">5</span><span class="p">])</span><span class="o">.</span><span class="n">rstrip</span><span class="p">()}</span>
    <span class="k">else</span><span class="p">:</span>
      <span class="k">pass</span>

  <span class="k">return</span> <span class="n">dbid_dict</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">all_build_dict</span><span class="p">(</span><span class="n">cursor</span><span class="p">):</span>  
    <span class="sd">&quot;&quot;&quot; Possible schema which have a column containing &#39;probe&#39;.</span>
<span class="sd">    In the future, we can implement this to draw from the table of </span>
<span class="sd">    acceptable tables --&gt;</span>
<span class="sd">    </span>
<span class="sd">    #  sql = &quot;select distinct(table_name) from table.table.table</span>
<span class="sd">    #  possible = []</span>
<span class="sd">    #  cursor.execute(sql)</span>
<span class="sd">    #  for row in cursor:</span>
<span class="sd">    #       possible.append(str(row[0]))</span>
<span class="sd">    </span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="n">possible</span> <span class="o">=</span> <span class="p">[</span><span class="s">&#39;MS043&#39;</span><span class="p">,</span> <span class="s">&#39;MS001&#39;</span><span class="p">,</span> <span class="s">&#39;MS005&#39;</span><span class="p">,</span> <span class="s">&#39;HT004&#39;</span><span class="p">]</span>

    <span class="n">od</span> <span class="o">=</span> <span class="p">{}</span>

    <span class="k">for</span> <span class="n">each_schema</span> <span class="ow">in</span> <span class="n">possible</span><span class="p">:</span>
      <span class="k">if</span> <span class="n">each_schema</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">od</span><span class="p">:</span>
          <span class="n">od</span><span class="p">[</span><span class="n">each_schema</span><span class="p">]</span> <span class="o">=</span> <span class="n">get_entity_id</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">each_schema</span><span class="p">)</span>
      <span class="k">else</span><span class="p">:</span>
        <span class="k">pass</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">possible_schema</span> <span class="o">=</span> <span class="n">all_build_dict</span><span class="p">(</span><span class="n">cursor</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Next, a very long function &quot;all_get_references&quot; does the mapping. The &quot;rules&quot; are here:</p>
<ol>
<li>The table has metadata listed in ltermeta</li>
<li>At least one column is named &quot;DATE_TIME or DATETIME&quot;</li>
</ol>
<p>If these are true...</p>
<ol>
<li>The column which contains the words &quot;DATE_TIME&quot; or &quot;DATETIME&quot; is assigned to the date_words slot in the yaml file, and we check that there is only one of these columns</li>
<li>The column which contains the word &quot;PROBE&quot; is given the probe_words slot in the yaml file, and we check there is only one of these columns.</li>
<li>The columns which contain &quot;MEAN&quot; or &quot;TOT&quot; are given the mean_words slot in the yaml file (will be separated later). Yes, &quot;MEAN_FLAG&quot; will be taken care of later, too.</li>
<li>The columns with &quot;METHOD&quot; is the method slot in the yaml file.</li>
</ol>
<p>The YAML files and also JSON files (easier for the web) are written out.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">all_get_references</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">od</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot; getting all the possible probe, mean, and method names. </span>
<span class="sd">    names that include &#39;mean&#39; should also include &#39;flag&#39;&quot;&quot;&quot;</span>

    <span class="c"># for example, each_schema is like &#39;MS043&#39; etc.</span>
    <span class="k">for</span> <span class="n">each_schema</span> <span class="ow">in</span> <span class="n">od</span><span class="o">.</span><span class="n">keys</span><span class="p">():</span>

        <span class="n">schema_d</span> <span class="o">=</span> <span class="p">{}</span>
        
        <span class="c"># for example, [&#39;MS04311&#39;, &#39;MS04312&#39;, etc] are in &#39;MS043&#39;</span>
        <span class="n">attr_list</span> <span class="o">=</span> <span class="n">od</span><span class="p">[</span><span class="n">each_schema</span><span class="p">]</span><span class="o">.</span><span class="n">keys</span><span class="p">()</span>

        <span class="k">for</span> <span class="n">my_attribute</span> <span class="ow">in</span> <span class="n">attr_list</span><span class="p">:</span>

            <span class="c"># for example, 1731 may be MS04311 entity</span>
            <span class="n">my_entity_id</span> <span class="o">=</span> <span class="nb">str</span><span class="p">(</span><span class="n">od</span><span class="p">[</span><span class="n">each_schema</span><span class="p">][</span><span class="n">my_attribute</span><span class="p">][</span><span class="s">&#39;entity_id&#39;</span><span class="p">])</span>
            
            <span class="c"># the list of attributes that are available on the probes, which are numbers</span>
            <span class="n">loa</span> <span class="o">=</span> <span class="n">get_attribute_id_for_probe</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">my_entity_id</span><span class="p">)</span>
            
            <span class="c"># the list of names containing attributes we desire (PROBE, MEAN, etc.)</span>
            <span class="k">try</span><span class="p">:</span>
                <span class="n">lon</span> <span class="o">=</span> <span class="n">get_attribute_names_for_probe_and_site</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">loa</span><span class="p">)</span>
            
            <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>
                <span class="k">print</span> <span class="s">&quot;there is no metadata for table &quot;</span> <span class="o">+</span> <span class="n">my_attribute</span>
                <span class="k">continue</span>

            <span class="c"># skip those which do not have &quot;DATE_TIME&quot;</span>
            <span class="k">print</span> <span class="s">&quot;checking for the existance of hr data and mean data&quot;</span>
            
            <span class="k">if</span> <span class="s">&quot;DATE_TIME&quot;</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">lon</span> <span class="ow">and</span> <span class="s">&quot;DATETIME&quot;</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">lon</span><span class="p">:</span>
                <span class="k">continue</span>

            <span class="k">elif</span> <span class="s">&quot;DATE_TIME&quot;</span> <span class="ow">in</span> <span class="n">lon</span> <span class="ow">or</span> <span class="s">&quot;DATETIME&quot;</span> <span class="ow">in</span> <span class="n">lon</span><span class="p">:</span>
                
                <span class="c"># what is the date word</span>
                <span class="n">date_word</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">lon</span> <span class="k">if</span> <span class="s">&#39;DATE&#39;</span> <span class="ow">in</span> <span class="n">x</span><span class="p">][</span><span class="mi">0</span><span class="p">]</span>
                
                <span class="c"># which is probe/probe_type, mean/meanflag</span>
                <span class="n">probe_word</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">lon</span> <span class="k">if</span> <span class="s">&#39;PROBE&#39;</span> <span class="ow">in</span> <span class="n">x</span><span class="p">][</span><span class="mi">0</span><span class="p">]</span>
                <span class="n">mean_words</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">lon</span> <span class="k">if</span> <span class="s">&#39;MEAN&#39;</span> <span class="ow">in</span> <span class="n">x</span> <span class="ow">or</span> <span class="s">&#39;TOT&#39;</span> <span class="ow">in</span> <span class="n">x</span><span class="p">]</span>
                <span class="n">method_words</span> <span class="o">=</span><span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">lon</span> <span class="k">if</span> <span class="s">&#39;METHOD&#39;</span> <span class="ow">in</span> <span class="n">x</span><span class="p">]</span>
                
                <span class="k">if</span> <span class="nb">len</span><span class="p">(</span><span class="n">mean_words</span><span class="p">)</span> <span class="o">&gt;=</span> <span class="mi">1</span><span class="p">:</span>

                    <span class="c"># this only needs to be processed one time, so let&#39;s get it right</span>
                    <span class="k">try</span><span class="p">:</span>
                        <span class="n">startdaydict</span><span class="p">,</span> <span class="n">enddaydict</span> <span class="o">=</span> <span class="n">epic_query</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">my_attribute</span><span class="p">,</span> <span class="n">probe_word</span><span class="p">,</span> <span class="n">date_word</span><span class="p">)</span>
                    <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>
                        <span class="k">continue</span>

                    <span class="k">if</span> <span class="n">my_attribute</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">schema_d</span><span class="p">:</span>
                        <span class="n">schema_d</span><span class="p">[</span><span class="n">my_attribute</span><span class="p">]</span> <span class="o">=</span><span class="p">{</span><span class="s">&#39;startdaydict&#39;</span><span class="p">:</span> <span class="n">startdaydict</span><span class="p">,</span> <span class="s">&#39;enddaydict&#39;</span><span class="p">:</span> <span class="n">enddaydict</span><span class="p">,</span> <span class="s">&#39;probe_word&#39;</span><span class="p">:</span> <span class="n">probe_word</span><span class="p">,</span> <span class="s">&#39;mean_words&#39;</span><span class="p">:</span> <span class="n">mean_words</span><span class="p">,</span> <span class="s">&#39;method_words&#39;</span><span class="p">:</span> <span class="n">method_words</span><span class="p">,</span> <span class="s">&#39;date_word&#39;</span><span class="p">:</span> <span class="n">date_word</span><span class="p">}</span>
                    
                    <span class="k">elif</span> <span class="n">my_attribute</span> <span class="ow">in</span> <span class="n">schema_d</span><span class="p">:</span>
                        <span class="k">print</span> <span class="s">&quot;my attribute should not already be here?&quot;</span>
                        <span class="kn">import</span> <span class="nn">pdb</span><span class="p">;</span> <span class="n">pdb</span><span class="o">.</span><span class="n">set_trace</span><span class="p">()</span>

                <span class="k">else</span><span class="p">:</span>
                    <span class="k">del</span> <span class="n">mean_words</span>
                    <span class="k">del</span> <span class="n">probe_word</span>
                    <span class="k">del</span> <span class="n">date_word</span>
                    <span class="k">del</span> <span class="n">method_words</span>
                    <span class="k">continue</span> 

            <span class="k">else</span><span class="p">:</span>
                <span class="k">print</span> <span class="s">&quot;We only have data that is daily for : &quot;</span> <span class="o">+</span> <span class="n">my_attribute</span>


        <span class="n">write_schema_to_yaml</span><span class="p">(</span><span class="n">each_schema</span><span class="p">,</span> <span class="n">schema_d</span><span class="p">)</span>
        <span class="n">write_schema_to_json</span><span class="p">(</span><span class="n">each_schema</span><span class="p">,</span> <span class="n">schema_d</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">all_get_references</span><span class="p">(</span><span class="n">cursor</span><span class="p">,</span> <span class="n">possible_schema</span><span class="p">)</span>
</pre></div>
...
<pre>
associating DATE_TIME with 7544
associating SOLAR_TOT_FLAG with 7584
associating PROBE_CODE with 7611
associating SOLAR_METHOD with 7660
associating SOLAR_TOT with 7680
associating SOLAR_MEAN with 7688
associating SOLAR_MEAN_FLAG with 7689
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating WSPD_PRO_MEAN_FLAG with 7598
associating WMAG_PRO_MEAN_FLAG with 7604
associating WDIR_PRO_MEAN_FLAG with 7605
associating PROBE_CODE with 7611
associating WIND_METHOD with 7659
associating WSPD_PRO_MEAN with 7676
associating WMAG_PRO_MEAN with 7677
associating WDIR_PRO_MEAN with 7678
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating DEWPT_MEAN_FLAG with 7569
associating PROBE_CODE with 7611
associating DEWPT_METHOD with 7662
associating DEWPT_MEAN with 7682
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating SOILMP_MEAN_FLAG with 7575
associating PROBE_CODE with 7611
associating SOILMP_METHOD with 7661
associating SOILMP_MEAN with 7681
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating AIRTEMP_MEAN_FLAG with 7592
associating PROBE_CODE with 7611
associating AIRTEMP_METHOD with 7655
associating AIRTEMP_MEAN with 7674
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PROBE_CODE with 7611
associating SNOW_METHOD with 7665
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PRECIP_TOT_FLAG with 7578
associating PROBE_CODE with 7611
associating PRECIP_TOT with 7633
associating PRECIP_METHOD with 7657
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating RELHUM_MEAN_FLAG with 7581
associating PROBE_CODE with 7611
associating RELHUM_METHOD with 7656
associating RELHUM_MEAN with 7675
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating SNOWMELT_TOT_FLAG with 7574
associating PROBE_CODE with 7611
associating SNOWMELT_TOT with 7637
associating SNOWMELT_METHOD with 7664
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating VPD_MEAN_FLAG with 7595
associating PROBE_CODE with 7611
associating VPD_METHOD with 7663
associating VPD_MEAN with 7683
associating VAP_MEAN with 8178
associating VAP_MEAN_FLAG with 8179
associating SATVP_MEAN with 8180
associating SATVP_MEAN_FLAG with 8181
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating SOILWC_MEAN_FLAG with 7586
associating PROBE_CODE with 7611
associating SOILWC_METHOD with 7673
associating SOILWC_MEAN with 8177
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PAR_MEAN_FLAG with 7579
associating PROBE_CODE with 7611
associating PAR_METHOD with 7658
associating PAR_MEAN with 7685
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating SOILTEMP_MEAN_FLAG with 7589
associating PROBE_CODE with 7611
associating SOILTEMP_METHOD with 7666
associating SOILTEMP_MEAN with 7684
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PROBE_CODE with 7611
associating SNOWDEP_MEAN with 7635
associating SWE_MEAN with 7639
associating SWE_METHOD with 7651
associating SWE_MEAN_FLAG with 7686
associating SNOWDEP_MEAN_FLAG with 7687
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PROBE_CODE with 7611
associating ATMPRESS_METHOD with 8173
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PROBE_CODE with 7611
associating SOLAR_METHOD with 7660
associating SW_IN_MEAN with 8151
associating SW_OUT_MEAN with 8152
associating LW_IN_MEAN with 8153
associating LW_OUT_MEAN with 8154
associating SW_IN_MEAN_FLAG with 8155
associating SW_OUT_MEAN_FLAG with 8156
associating LW_IN_MEAN_FLAG with 8157
associating LW_OUT_MEAN_FLAG with 8158
associating NR_TOT_MEAN with 8159
associating NR_TOT_MEAN with 8159
associating NR_TOT_MEAN_FLAG with 8160
associating NR_TOT_MEAN_FLAG with 8160
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PROBE_CODE with 7611
associating WIND_METHOD with 7659
associating WSPD_SNC_MEAN with 8141
associating WDIR_SNC_MEAN with 8143
associating WUX_SNC_MEAN with 8145
associating WUY_SNC_MEAN with 8147
associating WAIR_SNC_MEAN with 8149
associating WSPD_SNC_MEAN_FLAG with 8163
associating WDIR_SNC_MEAN_FLAG with 8165
associating WUX_SNC_MEAN_FLAG with 8167
associating WUY_SNC_MEAN_FLAG with 8169
associating WAIR_SNC_MEAN_FLAG with 8171
checking for the existance of hr data and mean data
associating DATE with 7543
associating RELHUM_MEAN_FLAG with 7581
associating PROBE_CODE with 7611
associating RELHUM_MEAN_DAY with 7623
associating RELHUM_METHOD with 7656
checking for the existance of hr data and mean data
associating DATE with 7543
associating PRECIP_TOT_FLAG with 7578
associating PROBE_CODE with 7611
associating PRECIP_TOT_DAY with 7632
associating PRECIP_METHOD with 7657
checking for the existance of hr data and mean data
associating DATE with 7543
associating AIRTEMP_MEAN_DAY with 7564
associating AIRTEMP_MEAN_FLAG with 7592
associating PROBE_CODE with 7611
associating AIRTEMP_METHOD with 7655
checking for the existance of hr data and mean data
...
associating SOILMP_MEAN_FLAG with 7575
associating PROBE_CODE with 7611
associating SOILMP_MEAN_DAY with 7625
associating SOILMP_METHOD with 7661
checking for the existance of hr data and mean data
associating DATE with 7543
associating DEWPT_MEAN_DAY with 7563
associating DEWPT_MEAN_FLAG with 7569
associating PROBE_CODE with 7611
associating DEWPT_METHOD with 7662
checking for the existance of hr data and mean data
associating DATE with 7543
associating WDIR_PRO_MEAN_DAY with 7567
associating WSPD_PRO_MEAN_FLAG with 7598
associating WSPD_ROSE5_MEAN_FLAG with 7599
associating WSPD_ROSE6_MEAN_FLAG with 7600
associating WSPD_ROSE7_MEAN_FLAG with 7601
associating WSPD_ROSE8_MEAN_FLAG with 7602
associating WMAG_PRO_MEAN_FLAG with 7604
associating WDIR_PRO_MEAN_FLAG with 7605
associating WSPD_ROSE1_MEAN_FLAG with 7607
associating WSPD_ROSE2_MEAN_FLAG with 7608
associating WSPD_ROSE3_MEAN_FLAG with 7609
associating WSPD_ROSE4_MEAN_FLAG with 7610
associating PROBE_CODE with 7611
associating WSPD_PRO_MEAN_DAY with 7627
associating WMAG_PRO_MEAN_DAY with 7641
associating WSPD_ROSE1_MEAN_DAY with 7642
associating WSPD_ROSE2_MEAN_DAY with 7643
associating WSPD_ROSE3_MEAN_DAY with 7644
associating WSPD_ROSE4_MEAN_DAY with 7645
associating WSPD_ROSE5_MEAN_DAY with 7646
associating WSPD_ROSE6_MEAN_DAY with 7647
associating WSPD_ROSE7_MEAN_DAY with 7648
associating WSPD_ROSE8_MEAN_DAY with 7649
associating WIND_METHOD with 7659
checking for the existance of hr data and mean data
associating DATE with 7543
associating SOLAR_TOT_FLAG with 7584
associating PROBE_CODE with 7611
associating SOLAR_TOT_DAY with 7640
associating SOLAR_METHOD with 7660
associating SOLAR_MEAN_FLAG with 7689
associating SOLAR_MEAN_DAY with 7690
checking for the existance of hr data and mean data
associating DATE with 7543
associating VPD_MEAN_FLAG with 7595
associating PROBE_CODE with 7611
associating VPD_MEAN_DAY with 7626
associating VPD_METHOD with 7663
associating VAP_MEAN_DAY with 8693
associating VAP_MEAN_FLAG with 8694
checking for the existance of hr data and mean data
associating DATE with 7543
associating SNOWMELT_TOT_FLAG with 7574
associating PROBE_CODE with 7611
associating SNOWMELT_TOT_DAY with 7636
associating SNOWMELT_METHOD with 7664
checking for the existance of hr data and mean data
associating DATE_TIME with 7544
associating PROBE_CODE with 7611
...
associating PROBE_CODE with 7611
associating SOILTEMP_METHOD with 7666
associating SOILTEMP_MEAN_DAY with 7667
checking for the existance of hr data and mean data
associating DATE with 7543
associating PAR_MEAN_FLAG with 7579
associating PROBE_CODE with 7611
associating PAR_MEAN_DAY with 7622
associating PAR_METHOD with 7658
checking for the existance of hr data and mean data
associating DATE with 7543
associating SOILWC_MEAN_FLAG with 7586
associating PROBE_CODE with 7611
associating SOILWC_MEAN_DAY with 7624
associating SOILWC_METHOD with 7673
checking for the existance of hr data and mean data
associating DATE with 7543
associating PROBE_CODE with 7611
...
associating WUY_SNC_MEAN_FLAG with 8169
associating WAIR_SNC_MEAN_FLAG with 8171
associating WSPD_SNC_MEAN_DAY with 8482
associating WMAG_SNC_MEAN_DAY with 8484
associating WMAG_SNC_MEAN_FLAG with 8485
associating WDIR_SNC_MEAN_DAY with 8486
associating WUX_SNC_MEAN_DAY with 8488
associating WUY_SNC_MEAN_DAY with 8489
associating WAIR_SNC_MEAN_DAY with 8492
checking for the existance of hr data and mean data
associating DATE with 7543
associating PROBE_CODE with 7611
associating SOLAR_METHOD with 7660
...
associating NR_TOT_MEAN_FLAG with 8160
associating NR_TOT_MEAN_FLAG with 8160
associating SW_IN_MEAN_DAY with 8686
associating SW_OUT_MEAN_DAY with 8687
associating LW_IN_MEAN_DAY with 8688
associating LW_OUT_MEAN_DAY with 8689
associating NR_TOT_MEAN_DAY with 8690
associating NR_TOT_MEAN_DAY with 8690
checking for the existance of hr data and mean data
there is no metadata for table MS00126
Successfully dumped the output to a yaml file
Successfully dumped the output to a json file
associating DATE_TIME with 4061
associating MEANTEMP with 4068
associating PROBE with 4082
checking for the existance of hr data and mean data
associating DATE_TIME with 4061
associating PROBE with 4082
associating MEANRH with 7018
checking for the existance of hr data and mean data
associating DATE with 4060
associating MEANTEMP with 4068
associating PROBE with 4082
checking for the existance of hr data and mean data
associating DATE_TIME with 4061
...
checking for the existance of hr data and mean data
associating DATE with 4060
associating MEANDEWDAY with 4066
associating MEANDEWNIT with 4067
checking for the existance of hr data and mean data
Successfully dumped the output to a yaml file
Successfully dumped the output to a json file
associating DATE_TIME with 4228
associating MEANTEMP with 4232
associating PROBE with 4240
checking for the existance of hr data and mean data
associating DATE_TIME with 4228
associating MEANTEMP with 4232
associating PROBE with 4240
checking for the existance of hr data and mean data
associating DATE with 4227
associating MEANTEMP with 4232
associating PROBE with 4240
checking for the existance of hr data and mean data
associating DATE with 4227
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>You can see in the above how the all_get_data process works -- the attributes in the schema are associated with column names. Then the column names are checked if they have high-resolution and mean data. If this is okay, then we go back and find the start and end date for each. The YAML and JSON files are written out.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
