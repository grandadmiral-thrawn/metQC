---
layout: post
title: "Glitching, Part 2-- What Is a Glitch"
date: 2015-07-31T13:52:07-07:00
---
<html>
<head>
...
<p>Here&#39;s a description of the GLITCH API and how the GLITCH works. First, we import the core functions that drive GLITCH. These are in the file &quot;glitch.py&quot; and &quot;logic_glitch.py&quot;. &quot;glitch.py&quot; does the math and &quot;logic_glitch.py&quot; does the deciding on which attribute we are working with (i.e. wind, solar radiation, temperature, etc.)</p>
</div>
</div>
</div>
...
<div class="highlight"><pre><span class="kn">from</span> <span class="nn">glitch</span> <span class="kn">import</span> <span class="o">*</span>
<span class="kn">import</span> <span class="nn">yaml</span>
<span class="kn">from</span> <span class="nn">logic_glitch</span> <span class="kn">import</span> <span class="o">*</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">get_yaml</span><span class="p">():</span>
    <span class="sd">&quot;&quot;&quot; This function drives the API to get the local YAML file containing important information about each table in a database&quot;&quot;&quot;</span>
    <span class="k">print</span> <span class="s">&quot;Please choose one of the following tables: MS043, MS001, MS005, HT004&quot;</span>
    <span class="n">table_name</span> <span class="o">=</span> <span class="nb">raw_input</span><span class="p">(</span><span class="s">&quot;Type your selection here --&gt; &quot;</span><span class="p">)</span>

    <span class="k">try</span><span class="p">:</span>
        <span class="n">strfilename</span> <span class="o">=</span> <span class="n">table_name</span><span class="p">[</span><span class="mi">0</span><span class="p">:</span><span class="mi">5</span><span class="p">]</span> <span class="o">+</span> <span class="s">&#39;.yml&#39;</span>
        <span class="n">u</span> <span class="o">=</span> <span class="n">yaml</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="nb">open</span><span class="p">(</span><span class="n">strfilename</span><span class="p">,</span><span class="s">&#39;r&#39;</span><span class="p">))</span>
        <span class="k">print</span> <span class="s">&quot;Success! Loaded &quot;</span> <span class="o">+</span> <span class="n">table_name</span>
        <span class="k">return</span> <span class="n">u</span>
    <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>
        <span class="k">print</span> <span class="s">&quot;Failure! Do you want to try again?&quot;</span>
        <span class="n">y_or_n</span> <span class="o">=</span> <span class="nb">raw_input</span><span class="p">(</span><span class="s">&quot;Type YES for trying again or press CTRL + C to exit the program&quot;</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">y_or_n</span> <span class="o">==</span> <span class="s">&quot;YES&quot;</span><span class="p">:</span>
            <span class="n">get_yaml</span><span class="p">()</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="o">%</span><span class="k">load_ext</span> <span class="n">yamlmagic</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">myTable</span> <span class="o">=</span> <span class="n">get_yaml</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">show_tables</span><span class="p">(</span><span class="n">loaded_yaml</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot; displays possible tables and probes&quot;&quot;&quot;</span>

    <span class="k">print</span><span class="p">(</span><span class="s">&#39;The possible tables are: &#39;</span><span class="p">)</span>
    <span class="k">for</span> <span class="n">index</span><span class="p">,</span> <span class="n">each_table</span> <span class="ow">in</span> <span class="nb">enumerate</span><span class="p">(</span><span class="nb">sorted</span><span class="p">(</span><span class="n">loaded_yaml</span><span class="o">.</span><span class="n">keys</span><span class="p">())):</span>
        <span class="k">print</span> <span class="nb">str</span><span class="p">(</span><span class="n">index</span><span class="p">)</span> <span class="o">+</span> <span class="s">&quot;. |   &quot;</span> <span class="o">+</span> <span class="n">each_table</span>

    <span class="n">table_choice</span> <span class="o">=</span> <span class="nb">raw_input</span><span class="p">(</span><span class="s">&#39;Choose one of the above tables--&gt; &#39;</span><span class="p">)</span>

    <span class="c"># if they give you an index rather than a table name, search by the index</span>

    <span class="k">if</span> <span class="nb">len</span><span class="p">(</span><span class="n">table_choice</span><span class="p">)</span> <span class="o">==</span> <span class="mi">1</span><span class="p">:</span>
        <span class="n">table_choice_name</span> <span class="o">=</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">loaded_yaml</span><span class="o">.</span><span class="n">keys</span><span class="p">())[</span><span class="nb">int</span><span class="p">(</span><span class="n">table_choice</span><span class="p">)]</span>
        <span class="n">table_choice</span> <span class="o">=</span> <span class="n">table_choice_name</span>
        <span class="k">del</span> <span class="n">table_choice_name</span>

    <span class="k">elif</span> <span class="nb">len</span><span class="p">(</span><span class="n">table_choice</span><span class="p">)</span> <span class="o">==</span> <span class="mi">7</span><span class="p">:</span>
        <span class="k">pass</span>

    <span class="k">else</span><span class="p">:</span>
        <span class="k">print</span> <span class="s">&quot;That is not a valid table choice. Please try again or press CTRL + C to exit&quot;</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>The table contains ALL THE INFORMATION we got from &quot;map_glitch.py&quot; (see its documentation). We&#39;ll probably have this in a SQL soon, but for now, it&#39;s a YAML table. It provides us the reference we need to know which probes are where and when they start and end.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">print</span><span class="p">(</span><span class="n">myTable</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Now, there are many smaller functions in glitch.py that aggregate, organize, define iterators, etc. but really those are nothing special apart from getting data into structures that Python likes to work with.  </p>
<p>A scientist appears with a need to know about the hourly temperature for PRIMET01 from 2012-10-01 to 2012-10-03. They don&#39;t want to compute it by hand. To obtain this data, and glitch it correctly, we instantiate a class of SmartGlitcher from logic_glitch.py. SmartGlitcher&#39;s &quot;rules&quot; rely on the function &quot;get_data_in_range&quot;, which I will show here:</p>
<p>RULES:</p>
<ol>
<li><p>The name of the table indicates which attributes it contains, and the default is to tables which have one &quot;mean_word&quot; (such as &quot;AIRTEMP_MEAN&quot;) and one associate flag (such as &quot;AIRTEMP_MEAN_FLAG&quot;). </p>
</li>
<li><p>If the table is one of the other ones we list, we do the following. For wind:</p>
</li>
</ol>
<pre><code>    if self.table in [&#39;MS04314&#39;, &#39;MS00114&#39;]:
        # speed
        valid_data = {}
        # magnitude
        valid_data2 = {}
...
</code></pre><p> Note that because the flag words are different in the old structure, they are coded in hard here, but will fall back to the standard names. So, if we update MS001 from FT1, FW3, etc., to the &quot;_FLAG&quot; convention, it will be accepted.</p>
<ol>
<li><p>For solar radiation, we have 2 mean words, MEAN and TOT. We obtain both of these.</p>
<pre><code>   elif self.table in [&#39;MS04315&#39;, &#39;MS00115&#39;]:
     valid_data = {}
     valid_data2 = {}
...
<li><p>For sonic, we have a lot of mean words, and we obtain all of them.</p>
<pre><code> elif self.table in [&#39;MS04334&#39;, &#39;MS00134&#39;]:
     # speed
     valid_data = {}
     # ux
     valid_data2 = {}
...
<ol>
<li><p>on Precip, we have 1 mean word, so the default rule applies for obtaining the data, although the value given is a &quot;tot&quot;.</p>
</li>
<li><p>For some of the HT004 and MS005 tables, the flags and values are still the old style. Like the MS001, the old values are hard coded in, with a fall back to a &quot;_FLAG&quot; and &quot;_MEAN&quot; convention.</p>
</li>
</ol>
<p>In the next cell, I&#39;ll show the full &quot;glitchme&quot; function that gathers the data, and then subsequently describe parts of it.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">glitchme</span><span class="p">(</span><span class="n">valid_data</span><span class="p">,</span> <span class="n">interval</span><span class="p">,</span> <span class="n">precip</span><span class="o">=</span><span class="bp">False</span><span class="p">):</span>
  <span class="sd">&#39;&#39;&#39; This function performs the GLITCH aggregation/interpolation. It defaults to the &quot;mean&quot; method, which means that each interval o&#39;&#39;&#39;</span>

  <span class="c"># holds the resulting data for each stop point, persists</span>
  <span class="n">results</span> <span class="o">=</span> <span class="p">{}</span>

  <span class="c"># Get all dates where we have valid data to key from</span>
  <span class="n">dr</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">valid_data</span><span class="o">.</span><span class="n">keys</span><span class="p">())]</span>

  <span class="n">first_date</span> <span class="o">=</span> <span class="n">dr</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">+</span> <span class="n">datetime</span><span class="o">.</span><span class="n">timedelta</span><span class="p">(</span><span class="n">minutes</span><span class="o">=</span><span class="n">interval</span><span class="p">)</span>
  <span class="n">last_date</span> <span class="o">=</span> <span class="n">dr</span><span class="p">[</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span> <span class="o">+</span> <span class="n">datetime</span><span class="o">.</span><span class="n">timedelta</span><span class="p">(</span><span class="n">minutes</span><span class="o">=</span><span class="n">interval</span><span class="p">)</span>

  <span class="c"># super_range is an ideal range from each interval to the next one (i.e. 15 minute intervals, 35 minute intervals, etc.)</span>
  <span class="n">super_range</span> <span class="o">=</span> <span class="n">drange</span><span class="p">(</span><span class="n">first_date</span><span class="p">,</span> <span class="n">last_date</span><span class="p">,</span> <span class="n">datetime</span><span class="o">.</span><span class="n">timedelta</span><span class="p">(</span><span class="n">minutes</span><span class="o">=</span><span class="n">interval</span><span class="p">))</span>

  <span class="c"># min range is an ideal range for one minute intervals to aggregate</span>
  <span class="n">minrange</span> <span class="o">=</span> <span class="p">[</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">drange</span><span class="p">(</span><span class="n">dr</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">dr</span><span class="p">[</span><span class="o">-</span><span class="mi">1</span><span class="p">],</span> <span class="n">datetime</span><span class="o">.</span><span class="n">timedelta</span><span class="p">(</span><span class="n">minutes</span><span class="o">=</span><span class="mi">1</span><span class="p">))]</span>

  <span class="c"># t_mean stores values for that interval and f_mean stores flags for that interval</span>
  <span class="n">t_mean</span> <span class="o">=</span><span class="p">[]</span>
  <span class="n">f_mean</span> <span class="o">=</span><span class="p">[]</span>
  
  <span class="c"># make an iterator to walk the known date range (i.e. 10:00, 10:05, 10:10 etc.)</span>
  <span class="n">starting</span> <span class="o">=</span> <span class="nb">iter</span><span class="p">(</span><span class="n">dr</span><span class="p">)</span>

  <span class="c"># ex. 2010-10-01 00:00:00</span>
  <span class="n">this_date</span> <span class="o">=</span> <span class="n">starting</span><span class="o">.</span><span class="n">next</span><span class="p">()</span>

  <span class="c"># ex. 2010-10-01 00:05:00</span>
  <span class="k">try</span><span class="p">:</span>
    <span class="n">subsequent</span> <span class="o">=</span> <span class="n">starting</span><span class="o">.</span><span class="n">next</span><span class="p">()</span>
  <span class="k">except</span> <span class="ne">StopIteration</span><span class="p">:</span>
    <span class="k">print</span> <span class="s">&quot;&quot;&quot;You have selected an ending date which occurs prior to the next measurement. Try adding a small amount of time to the input ending date.</span>
<span class="s">    For example, if you gave 2002-10-02 00:00:00 and 2002-10-03 00:00:00 for PPTCEN01, this daily measurement would only include that first midnight point. You could change the end date to 2002-10-03 00:05:00, which would then make sure that the total found at 2002-10-03 was distributed back over the previous interval if needed.</span>
<span class="s">    &quot;&quot;&quot;</span>

  <span class="c"># first point to put in for the glitch (ex 2010-10-01 00:15:00)</span>
  <span class="n">checkpoint</span> <span class="o">=</span> <span class="n">super_range</span><span class="o">.</span><span class="n">next</span><span class="p">()</span>

  <span class="c"># the the attribute is precip or solar tot, we need to get a sum, so the one minute values are actually representative of 1/length of interval that quantity</span>

  <span class="k">if</span> <span class="n">precip</span><span class="o">==</span><span class="bp">True</span><span class="p">:</span>
    <span class="n">duration_1</span><span class="o">=</span> <span class="p">(</span><span class="n">subsequent</span><span class="o">-</span><span class="n">this_date</span><span class="p">)</span>
    <span class="n">duration</span> <span class="o">=</span> <span class="n">duration_1</span><span class="o">.</span><span class="n">seconds</span><span class="o">/</span><span class="mi">60</span> <span class="o">+</span> <span class="n">duration_1</span><span class="o">.</span><span class="n">days</span><span class="o">*</span><span class="p">(</span><span class="mi">86400</span><span class="o">/</span><span class="mi">60</span><span class="p">)</span>
    
  <span class="k">else</span><span class="p">:</span>
    <span class="n">duration</span> <span class="o">=</span> <span class="mi">1</span>


  <span class="k">for</span> <span class="n">each_minute</span> <span class="ow">in</span> <span class="n">minrange</span><span class="p">:</span>
    <span class="c"># if the minute is the checkpoint, update the dictionary to the accumulated values</span>
    <span class="c"># for example if it is 10-01-01 13:00:00 and that&#39;s a 13 min checkpoint, we get the values from 0-12 minutes in the dictionary for that checkpoint(so it is the previous minutes to that one)</span>

    <span class="k">if</span> <span class="n">each_minute</span> <span class="o">==</span> <span class="n">checkpoint</span><span class="p">:</span>

      <span class="k">if</span> <span class="n">checkpoint</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">results</span><span class="p">:</span>
        <span class="n">results</span><span class="p">[</span><span class="n">checkpoint</span><span class="p">]</span> <span class="o">=</span> <span class="p">{</span><span class="s">&#39;val&#39;</span><span class="p">:</span> <span class="n">t_mean</span><span class="p">,</span> <span class="s">&#39;fval&#39;</span><span class="p">:</span> <span class="n">f_mean</span><span class="p">}</span>

      <span class="k">else</span><span class="p">:</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&quot;Check point at &quot;</span> <span class="o">+</span> <span class="n">datetime</span><span class="o">.</span><span class="n">datetime</span><span class="o">.</span><span class="n">strftime</span><span class="p">(</span><span class="n">each_minute</span><span class="p">,</span> <span class="s">&#39;%Y-%m-</span><span class="si">%d</span><span class="s"> %H:%M:%S&#39;</span><span class="p">)</span> <span class="o">+</span> <span class="s">&quot;is in the rsults already!&quot;</span><span class="p">)</span>
        <span class="kn">import</span> <span class="nn">pdb</span><span class="p">;</span> <span class="n">pdb</span><span class="o">.</span><span class="n">set_trace</span><span class="p">()</span>

      <span class="c"># set the storage to empty</span>
      <span class="n">t_mean</span> <span class="o">=</span> <span class="p">[]</span>
      <span class="n">f_mean</span> <span class="o">=</span> <span class="p">[]</span>

      <span class="c"># update the checkpoint by 1:</span>
      <span class="n">checkpoint</span> <span class="o">=</span> <span class="n">super_range</span><span class="o">.</span><span class="n">next</span><span class="p">()</span>
    ...
    <span class="c"># we still have to check if the value changes and start accumulating to the next date...</span>
    <span class="c"># this would get say between 10-01-01 00:00:00 and 10-01-01 00:00:04</span>
    <span class="k">if</span> <span class="n">each_minute</span> <span class="o">&gt;=</span> <span class="n">this_date</span> <span class="ow">and</span> <span class="n">each_minute</span> <span class="o">&lt;</span> <span class="n">subsequent</span><span class="p">:</span>

      <span class="k">try</span><span class="p">:</span>
        <span class="n">t_mean</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="nb">round</span><span class="p">(</span><span class="nb">float</span><span class="p">(</span><span class="n">valid_data</span><span class="p">[</span><span class="n">this_date</span><span class="p">][</span><span class="s">&#39;attr&#39;</span><span class="p">])</span><span class="o">/</span><span class="n">duration</span><span class="p">,</span><span class="mi">3</span><span class="p">))</span>
      <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>
        <span class="c">#import pdb; pdb.set_trace()</span>
        <span class="c">#print &quot;none value found as &quot; + str(valid_data[this_date][&#39;attr&#39;]) + &quot; on &quot; + datetime.datetime.strftime(this_date, &#39;%Y-%m-%d %H:%M:%S&#39;)</span>
        <span class="n">t_mean</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">valid_data</span><span class="p">[</span><span class="n">this_date</span><span class="p">][</span><span class="s">&#39;attr&#39;</span><span class="p">])</span>

      <span class="n">f_mean</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">valid_data</span><span class="p">[</span><span class="n">this_date</span><span class="p">][</span><span class="s">&#39;flag&#39;</span><span class="p">])</span>

    <span class="k">elif</span> <span class="n">each_minute</span> <span class="o">==</span> <span class="n">subsequent</span><span class="p">:</span>

      <span class="c"># move up by one in the original search</span>
      <span class="n">this_date</span> <span class="o">=</span> <span class="n">subsequent</span>
      <span class="n">subsequent</span> <span class="o">=</span> <span class="n">starting</span><span class="o">.</span><span class="n">next</span><span class="p">()</span>

      <span class="c"># compute the number of minutes in the duration</span>
      <span class="k">if</span> <span class="n">precip</span><span class="o">==</span><span class="bp">True</span><span class="p">:</span>
        <span class="n">duration_1</span><span class="o">=</span> <span class="p">(</span><span class="n">subsequent</span><span class="o">-</span><span class="n">this_date</span><span class="p">)</span>
        <span class="n">duration</span> <span class="o">=</span> <span class="n">duration_1</span><span class="o">.</span><span class="n">seconds</span><span class="o">/</span><span class="mi">60</span> <span class="o">+</span> <span class="n">duration_1</span><span class="o">.</span><span class="n">days</span><span class="o">*</span><span class="p">(</span><span class="mi">86400</span><span class="o">/</span><span class="mi">60</span><span class="p">)</span>
    ...
    <span class="k">elif</span> <span class="n">each_minute</span> <span class="o">&gt;=</span> <span class="n">subsequent</span><span class="p">:</span>
      <span class="k">print</span> <span class="s">&quot;the minute should not exceed the subsequent&quot;</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>To break this down, look at the next &quot;cell&quot; of raw code. First, we make an array for the results, and we get all the valid data points from our inputs. i.e. sometimes we may have a missing data, etc., and that is okay, but we must make sure our dates and our data are aligned. We then assign first_date and last_date based on this information and generate an ideal range using the drange function, a.k.a. the best iterator in all of the world. The iterator is in units of 1 minute. That means if the values are 2 hours apart, you&#39;ll get 120 units. If they are 5 minutes apart, you&#39;ll get 5 units. If they are varying each time, for whatever reason, no problem, you&#39;ll get that many units.</p>
<p>We create two storage outputs t_mean = [] and f_mean = [], and these will hold the values and flags for that period. We make a second iterator which is in charge of walking over the raw data, it is called &quot;starting&quot;. &quot;starting&quot; will walk the data until it reaches the end of it. Between each value of starting, we will fill in five minute values as appropriate.</p>
<p>3 iterators are used:</p>
<ol>
<li>iterating over &#39;1-minute steps&#39; - &quot;each_minute&quot;</li>
<li>iterating over real datetimes from the raw data (&quot;this date&quot; and &quot;subsequent&quot;)</li>
<li>iterating over the ideal dates we will glitch to (&quot;checkpoint&quot;)</li>
</ol>
<p>RULE 1: </p>
<ol>
<li>If Precip is True, then each of the one-minute values is a fraction of the number of intervals over which it is divided. For example if it were 1 hour data, and Precip was True, and the value was 6 mm, then each 1 minute value would be 0.1 mm (6/60). </li>
</ol>
<p>The variable &quot;duration&quot; then, is essentially a divisor, and usually it is 1.</p>
<p>We create an range &quot;super range&quot; which is another ideal iterator, based on the interval the user wants, and the current placement along that iterator is called &quot;check point&quot;. So if you want 40 minute data, it will work from the start date until as far as it can get 40 minute intervals. For example, 2:20, 3:00, 3:40, etc.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<pre><code>    # holds the resulting data for each stop point, persists
      results = {}
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>In the cell below, we do the magic of appending the data to the t_mean and f_mean lists, moving minute by minute.</p>
<p>Let&#39;s say we have a value of 6 mm Precip on PRIMET at 1:00 AM and a value of 3 mm Precip on PRIMET at 2:00 AM. Then we divide each of these by 60 to get .1 mm of precip every minute on PRIMET from 12 am to 1 am and .05 mm of precip on PRIMET from 1 am to 2 am. </p>
<p>Or...</p>
<p>Let&#39;s say we have an air temp of 15 C on CENMET at 16:45 PM and an air temp of 18 C on CENMET at 17:00 PM. Then we allocate the 15 C 15 x to the time from 16:30 PM to 16:44 PM and the 18 C 15 times from 16:45 PM to 16:59 PM (this is so we can assume that last measurement indeed reflect the prior interval - i.e. the 2400 measurement, if it existed, would be about 2355 to 2400 and not about 2400 to 005.)</p>
<p>RULE 2:</p>
<p>If a one minute value coincides with a checkpoint based on the super_range list, we will update the results array with the list of t_mean and f_mean, and give each a key of &#39;val&#39; or &#39;fval&#39;. We will clear out the t_mean and f_mean storages, and update the check point to look for the next value in our ideal range.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<pre><code>    for each_minute in minrange:
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>It&#39;s also important that we know what value to put towards t_mean and f_mean. That is from the third iterator, which walks over the raw data. When we hit a change in value, we need to make sure that it is applied. However, we want the value to apply to the one minutes that contributed to it, not the one follow it. So &quot;subsequent&quot; essentially tracks where your cutoff is, whereas &quot;this date&quot; tracks the start of that period that contributes to subsequent. It&#39;s hard to describe with words, so here&#39;s an example.</p>
<p>Imagine, you want values at 12:20 and 12:40. you have five minute data. If you check for the values of 12:15, 12:16, 12:17, 12:18, 12:19 and 12:20, that is representing the information that happened during all the seconds from 12:15:00-12:15:59, 12:16:00-12:16:59, etc. So the 12:19:59 value is in there also. So the 12:20 checkpoint is describing everything that contributed to the 12:20 value, and the 12:40 everything that contributed to ther 12:40 value, so in this case, what happens at 12:20:00 is actually a contributor to the 12:40 data point, because it happens &quot;after&quot; 12:20.</p>
<p>RULE 3:</p>
<p>We always check that the one-minute data is &gt;= the &quot;prior interval&quot; (this date) or &lt; the &quot;next interval&quot; (subsequent). </p>
<p>If this is true, we allocate the appropriate 5 minute value (the one associated with the &quot;prior interval&quot;) to each of those times, and append it to the t_mean or f_mean.</p>
<p>RULE 4: </p>
<p>If the one-minute value is the same as the subsequent, then we move up the raw data iterator by 1 set.</p>
<p>Continuing the example... if you are looking for 12:23 and you have 5 minute data, and you want 10 minute data, and the value measured at 12:15 was 14 C, at 12:20 was 15 C, and the value at 12:25 was 18 C , you will be giving to 12:23 2 units of 14 C (12:13, 12:14), 5 units of 15 C (12:15, 12:16, 12:17, 12:18, 12:19), and 3 units of 18 C (12:20, 12:21, 12:22). </p>
<p>So if 12:10 is this date, and 12:15 is subsequent, when we hit 12:15, then we move the iterator up by one, so now this_date is 12:15 and subsequent is 12:20. So for all the values which are 12:15, 12:16, 12:17, 12:18, 12:19, they are eating the 12:20 output, which is what they represent.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<pre><code>        # we still have to check if the value changes and start accumulating to the next date...
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>The create_glitch function does the summation for the simple mean and total cases.</p>
<p>This is actually pretty simple because our structure is so friendly. We had just made a structure, results, which contains a date and all the 1 minute values that contribute to its mean or total. We sort this structure in date order (for the purpose of aggregation) </p>
<p>we have something like </p>
<p>results[&#39;2012-12-20 00:30:00&#39;] = {&#39;val&#39;:[1, 2, 2, 1, 2], &#39;fval&#39;: [A, A, A, A, A]}</p>
<p>And when it&#39;s precip, we&#39;ve already made it into the smaller values, so we can just take a mean over that list, and run the flag algorithm over the flags.</p>
<p>Soon we will see the wind isn&#39;t even so bad. </p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Rules summary==&gt; for table selection:</p>
<ol>
<li><p>The default method for table processing is that there is some ONE attribute which contains the word &quot;MEAN&quot; or &quot;TOT&quot; and some flag which contains this word and &quot;FLAG&quot;. </p>
</li>
<li><p>When there is more than one attribute or a specific table type, like Wind is supplied, then the programmed table names (MS04314, MS04334, etc.) are used to identify these tables. This, of course, could be extracted into a separate table.</p>
</li>
<li><p>The flag &quot;Precip&quot; in the name is used to indicate if a &quot;TOT&quot; method should be used. So for solar TOT, this same flag is used.</p>
</li>
<li><p>The default flag assumes the &quot;mean word&quot; associated with it (be it UX or MEAN or TOT) and the word &quot;flag&quot;. If the flag has a &quot;weird old name&quot; like FT1 or FW2, this is &quot;hard coded&quot; in, but the fall back will be to the &quot;flag&quot; construction.</p>
</li>
<li><p>If a sensor fails one of these assumptions about names, it will try to fall back to the MEAN/FLAG configuration. Otherwise it will fail completely.</p>
</li>
<li><p>Map_glitch generates the YAML used to do this mapping, and should be run whenever a table has a big change.</p>
</li>
</ol>
<p>Rules summary==&gt; for &quot;glitchme&quot;</p>
<ol>
<li><p>If the parameter &quot;Precip&quot; is true, then we know we have a &quot;total&quot; and should divide our allocations by the number of 1 minute intervals used.</p>
</li>
<li><p>If a one minute value coincides with a checkpoint based on the super_range list, we update the results array with the lists of one minute values and flags associated with that interval, clear out the t_mean and f_mean storages, and update the check point to look for the next interval we desire.</p>
</li>
<li><p>We always check that the one-minute data is within the measured observations and precedes the last observation. While this is true, we allocate the appropriate high-res data value to each of those times, and append it to the t_mean or f_mean.</p>
</li>
<li><p>If the one-minute value is the last of the measured observations, then we allocate to it the high-res data value of the next measurement period, and append it to t_mean and f_mean.</p>
</li>
<li><p>When our iterator terminates, we have a list of one minute values and flags which represent an allocation of means or fractions of sums, and when we have these we can use create_glitch and logic to figure out what to accumulate.</p>
</li>
</ol>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>In &quot;create_glitch&quot;, the results outputs are aggregated: </p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">def</span> <span class="nf">create_glitch</span><span class="p">(</span><span class="n">results</span><span class="p">,</span> <span class="n">precip</span><span class="o">=</span><span class="bp">False</span><span class="p">):</span>
  <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">  Applies to all criteria EXCEPT Wind Magnitude, Wind Direction, and some of the sonic things</span>
<span class="sd">  If the attribute is wind speed, an additional flag is needed, copy from wind mag, where it is implemented</span>
<span class="sd">  &quot;&quot;&quot;</span>
  <span class="c"># output structure</span>
  <span class="n">final_glitch</span> <span class="o">=</span> <span class="p">{}</span>
  <span class="k">for</span> <span class="n">each_glitch</span> <span class="ow">in</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">results</span><span class="o">.</span><span class="n">keys</span><span class="p">()):</span>
    
    <span class="k">if</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">]</span> <span class="o">!=</span> <span class="p">[]:</span>

      <span class="c"># if the data is precip (or solar total), the results are a sum of the intermediate values, after you have divided by the duration of the interval. If Nones exist it won&#39;t add so you will need to instead do the sum of the intermediate values which are not None.</span>
      <span class="k">if</span> <span class="n">precip</span><span class="o">==</span><span class="bp">True</span><span class="p">:</span>

        <span class="k">try</span><span class="p">:</span>
          <span class="n">meanval</span> <span class="o">=</span> <span class="nb">round</span><span class="p">(</span><span class="nb">sum</span><span class="p">(</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">]),</span><span class="mi">2</span><span class="p">)</span>
        
        <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>
          <span class="n">values</span> <span class="o">=</span> <span class="p">[</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">][</span><span class="n">index</span><span class="p">]</span> <span class="k">for</span> <span class="n">index</span><span class="p">,</span><span class="n">x</span> <span class="ow">in</span> <span class="nb">enumerate</span><span class="p">(</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])</span> <span class="k">if</span> <span class="n">x</span> <span class="o">!=</span> <span class="bp">None</span> <span class="ow">and</span> <span class="n">x</span> <span class="o">!=</span> <span class="s">&quot;None&quot;</span><span class="p">]</span>

          <span class="k">if</span> <span class="n">values</span> <span class="o">==</span> <span class="p">[]:</span>
            <span class="n">meanval</span> <span class="o">=</span> <span class="s">&quot;None&quot;</span>
          
          <span class="k">else</span><span class="p">:</span>
            <span class="n">meanval</span> <span class="o">=</span> <span class="nb">round</span><span class="p">(</span><span class="nb">sum</span><span class="p">(</span><span class="n">values</span><span class="p">),</span><span class="mi">2</span><span class="p">)</span>
      
      <span class="c"># in the generic case the mean is the sum of the results divided by the total number of values contributing to it. But if there are nones, we will need to only divide by the number of relevant values</span>
      <span class="k">else</span><span class="p">:</span>
        <span class="k">try</span><span class="p">:</span> 
          <span class="n">meanval</span> <span class="o">=</span> <span class="nb">round</span><span class="p">(</span><span class="nb">sum</span><span class="p">(</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])</span><span class="o">/</span><span class="nb">len</span><span class="p">(</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">]),</span><span class="mi">2</span><span class="p">)</span>
        <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>
          <span class="n">values</span> <span class="o">=</span> <span class="p">[</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">][</span><span class="n">index</span><span class="p">]</span> <span class="k">for</span> <span class="n">index</span><span class="p">,</span><span class="n">x</span> <span class="ow">in</span> <span class="nb">enumerate</span><span class="p">(</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])</span> <span class="k">if</span> <span class="n">x</span> <span class="o">!=</span> <span class="bp">None</span> <span class="ow">and</span> <span class="n">x</span> <span class="o">!=</span> <span class="s">&quot;None&quot;</span><span class="p">]</span>

          <span class="k">if</span> <span class="n">values</span> <span class="o">==</span> <span class="p">[]:</span>
            <span class="k">print</span> <span class="s">&quot;The entire interval contains only bad values: &quot;</span> <span class="o">+</span> <span class="n">datetime</span><span class="o">.</span><span class="n">datetime</span><span class="o">.</span><span class="n">strftime</span><span class="p">(</span><span class="n">each_glitch</span><span class="p">,</span><span class="s">&#39;%Y-%m-</span><span class="si">%d</span><span class="s"> %H:%M:%S&#39;</span><span class="p">)</span>
            <span class="n">meanval</span> <span class="o">=</span> <span class="s">&quot;None&quot;</span>
          
          <span class="k">else</span><span class="p">:</span>
            <span class="n">meanval</span> <span class="o">=</span> <span class="nb">round</span><span class="p">(</span><span class="nb">sum</span><span class="p">(</span><span class="n">values</span><span class="p">)</span><span class="o">/</span><span class="nb">len</span><span class="p">(</span><span class="n">values</span><span class="p">),</span><span class="mi">2</span><span class="p">)</span>

      <span class="k">try</span><span class="p">:</span>
        
        <span class="n">num_flags</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">])</span>

        <span class="k">if</span> <span class="s">&#39;E&#39;</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]</span> <span class="ow">and</span> <span class="s">&#39;M&#39;</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]</span> <span class="ow">and</span> <span class="s">&#39;Q&#39;</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]:</span>
          <span class="n">flagged_val</span> <span class="o">=</span> <span class="s">&#39;A&#39;</span>
        
        <span class="k">else</span><span class="p">:</span>
          <span class="n">numM</span> <span class="o">=</span> <span class="nb">len</span><span class="p">([</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]</span> <span class="k">if</span> <span class="n">x</span> <span class="o">==</span> <span class="s">&#39;M&#39;</span><span class="p">])</span>
          <span class="n">numE</span> <span class="o">=</span> <span class="nb">len</span><span class="p">([</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]</span> <span class="k">if</span> <span class="n">x</span> <span class="o">==</span> <span class="s">&#39;E&#39;</span><span class="p">])</span>
          <span class="n">numQ</span> <span class="o">=</span> <span class="nb">len</span><span class="p">([</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]</span> <span class="k">if</span> <span class="n">x</span> <span class="o">==</span> <span class="s">&#39;Q&#39;</span><span class="p">])</span>

          <span class="k">if</span> <span class="n">numM</span><span class="o">/</span><span class="n">num_flags</span> <span class="o">&gt;</span> <span class="mf">0.8</span><span class="p">:</span>
            <span class="n">flagged_val</span> <span class="o">=</span> <span class="s">&#39;M&#39;</span>
            <span class="n">mean_val</span> <span class="o">=</span> <span class="bp">None</span>
          <span class="k">elif</span> <span class="n">numE</span><span class="o">/</span><span class="n">num_flags</span> <span class="o">&gt;</span> <span class="mf">0.05</span><span class="p">:</span>
            <span class="n">flagged_val</span> <span class="o">=</span> <span class="s">&#39;E&#39;</span>
          <span class="k">elif</span> <span class="p">(</span><span class="n">numE</span> <span class="o">+</span> <span class="n">numM</span> <span class="o">+</span> <span class="n">numQ</span><span class="p">)</span><span class="o">/</span><span class="n">num_flags</span> <span class="o">&gt;</span> <span class="mf">0.05</span><span class="p">:</span>
            <span class="n">flagged_val</span> <span class="o">=</span> <span class="s">&#39;Q&#39;</span>
          <span class="k">else</span><span class="p">:</span>
            <span class="n">flagged_val</span> <span class="o">=</span> <span class="s">&#39;A&#39;</span>
    ...
    <span class="k">elif</span> <span class="n">results</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;fval&#39;</span><span class="p">]</span> <span class="o">==</span> <span class="p">[]:</span>
      <span class="n">meanval</span> <span class="o">=</span> <span class="bp">None</span>
      <span class="n">flagged_val</span> <span class="o">=</span> <span class="s">&#39;M&#39;</span>

    <span class="n">final_glitch</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">]</span> <span class="o">=</span> <span class="p">{</span><span class="s">&#39;mean&#39;</span><span class="p">:</span> <span class="n">meanval</span><span class="p">,</span> <span class="s">&#39;flags&#39;</span><span class="p">:</span> <span class="n">flagged_val</span><span class="p">}</span>

  <span class="k">return</span> <span class="n">final_glitch</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>So, that&#39;s some normal data. For wind and solar, similar methods are used. I won&#39;t put them all here for now, but I will show a few simple examples. (All of this is in glitch.py). Here&#39;s magnitude, for example. Wind Magnitude, as we know, means we need to get all the x and y vectors of the wind, sum them up, and take a mean of this.</p>
<p>For example, if the wind was having a &quot;speed&quot; of 10 m/s over 5 minutes, if it&#39;s not always going in some certain direction, it&#39;s actually not so fast. Some of that speed is being given to lateral movement. By decomposing the direction we can take care of this. All we do is apply this decomposition to the values coming out of the results (which are still in one minute sets) for speed and direction, so we effectively allocate the magnitude calculation to each one minute magnitude, and then sum.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="k">for</span> <span class="n">each_glitch</span> <span class="ow">in</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">results1</span><span class="o">.</span><span class="n">keys</span><span class="p">()):</span>
    <span class="k">if</span> <span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">]</span> <span class="o">!=</span> <span class="p">[]:</span>

      <span class="n">num_valid_obs</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])</span>
  
      <span class="k">try</span><span class="p">:</span>
        <span class="c"># find all the y parts and add them up, find all the x parts and add them up, take the square root</span>
        <span class="n">ypart</span> <span class="o">=</span> <span class="p">(</span><span class="nb">sum</span><span class="p">([</span><span class="nb">float</span><span class="p">(</span><span class="n">speed</span><span class="p">)</span> <span class="o">*</span> <span class="n">math</span><span class="o">.</span><span class="n">sin</span><span class="p">(</span><span class="n">math</span><span class="o">.</span><span class="n">radians</span><span class="p">(</span><span class="nb">float</span><span class="p">(</span><span class="n">x</span><span class="p">)))</span> <span class="k">for</span> <span class="p">(</span><span class="n">speed</span><span class="p">,</span> <span class="n">x</span><span class="p">)</span> <span class="ow">in</span> <span class="n">itertools</span><span class="o">.</span><span class="n">izip</span><span class="p">(</span><span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">],</span> <span class="n">results2</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])])</span><span class="o">/</span><span class="n">num_valid_obs</span><span class="p">)</span><span class="o">**</span><span class="mi">2</span> 
        
        <span class="n">xpart</span> <span class="o">=</span> <span class="p">(</span><span class="nb">sum</span><span class="p">([</span><span class="nb">float</span><span class="p">(</span><span class="n">speed</span><span class="p">)</span> <span class="o">*</span> <span class="n">math</span><span class="o">.</span><span class="n">cos</span><span class="p">(</span><span class="n">math</span><span class="o">.</span><span class="n">radians</span><span class="p">(</span><span class="nb">float</span><span class="p">(</span><span class="n">x</span><span class="p">)))</span> <span class="k">for</span> <span class="p">(</span><span class="n">speed</span><span class="p">,</span> <span class="n">x</span><span class="p">)</span> <span class="ow">in</span> <span class="n">itertools</span><span class="o">.</span><span class="n">izip</span><span class="p">(</span><span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">],</span><span class="n">results2</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])])</span><span class="o">/</span><span class="n">num_valid_obs</span><span class="p">)</span><span class="o">**</span><span class="mi">2</span> 
        
        <span class="n">glitched_mag</span> <span class="o">=</span> <span class="n">math</span><span class="o">.</span><span class="n">sqrt</span><span class="p">(</span><span class="n">ypart</span> <span class="o">+</span> <span class="n">xpart</span><span class="p">)</span>
      
      <span class="k">except</span> <span class="ne">Exception</span><span class="p">:</span>

        <span class="c"># when some of the values are none, only do the values we need</span>
        <span class="n">num_valid_obs</span> <span class="o">=</span> <span class="nb">len</span><span class="p">([</span><span class="n">x</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">]</span> <span class="k">if</span> <span class="n">x</span> <span class="o">!=</span> <span class="bp">None</span> <span class="ow">and</span> <span class="n">x</span> <span class="o">!=</span> <span class="s">&#39;None&#39;</span><span class="p">])</span>

        <span class="n">ypart</span> <span class="o">=</span> <span class="p">(</span><span class="nb">sum</span><span class="p">([</span><span class="nb">float</span><span class="p">(</span><span class="n">speed</span><span class="p">)</span> <span class="o">*</span> <span class="n">math</span><span class="o">.</span><span class="n">sin</span><span class="p">(</span><span class="n">math</span><span class="o">.</span><span class="n">radians</span><span class="p">(</span><span class="nb">float</span><span class="p">(</span><span class="n">x</span><span class="p">)))</span> <span class="k">for</span> <span class="p">(</span><span class="n">speed</span><span class="p">,</span> <span class="n">x</span><span class="p">)</span> <span class="ow">in</span> <span class="n">itertools</span><span class="o">.</span><span class="n">izip</span><span class="p">(</span><span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">],</span> <span class="n">results2</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])</span> <span class="k">if</span> <span class="n">speed</span> <span class="o">!=</span> <span class="s">&#39;None&#39;</span> <span class="ow">and</span> <span class="n">x</span> <span class="o">!=</span> <span class="s">&#39;None&#39;</span><span class="p">])</span><span class="o">/</span><span class="n">num_valid_obs</span><span class="p">)</span><span class="o">**</span><span class="mi">2</span>  
        <span class="n">xpart</span> <span class="o">=</span> <span class="p">(</span><span class="nb">sum</span><span class="p">([</span><span class="nb">float</span><span class="p">(</span><span class="n">speed</span><span class="p">)</span> <span class="o">*</span> <span class="n">math</span><span class="o">.</span><span class="n">cos</span><span class="p">(</span><span class="n">math</span><span class="o">.</span><span class="n">radians</span><span class="p">(</span><span class="nb">float</span><span class="p">(</span><span class="n">x</span><span class="p">)))</span> <span class="k">for</span> <span class="p">(</span><span class="n">speed</span><span class="p">,</span> <span class="n">x</span><span class="p">)</span> <span class="ow">in</span> <span class="n">itertools</span><span class="o">.</span><span class="n">izip</span><span class="p">(</span><span class="n">results1</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">],</span><span class="n">results2</span><span class="p">[</span><span class="n">each_glitch</span><span class="p">][</span><span class="s">&#39;val&#39;</span><span class="p">])</span> <span class="k">if</span> <span class="n">speed</span> <span class="o">!=</span> <span class="s">&#39;None&#39;</span> <span class="ow">and</span> <span class="n">x</span> <span class="o">!=</span> <span class="s">&#39;None&#39;</span><span class="p">])</span><span class="o">/</span><span class="n">num_valid_obs</span><span class="p">)</span><span class="o">**</span><span class="mi">2</span> 
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>A similar approach is used for the Sonic, although it is simpler because the vectors are already decomposed. For the wind direction, we use the Yamartino method (which is what Campbell uses) to weight the wind direction by speed. You can read about it here:</p>
<p><a href="https://www.campbellsci.com/wind-speed-direction?r">https://www.campbellsci.com/wind-speed-direction?r</a> </p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>This is how the Yamartino is calculated. Very fun!</p>
<pre><code>    theta_u = math.atan2(sum([float(speed) * math.sin(math.radians(float(x))) for (speed, x) in itertools.izip(results1[each_glitch][&#39;val&#39;], results2[each_glitch][&#39;val&#39;])])/num_valid_obs, sum([float(speed) * math.cos(math.radians(float(x))) for (speed, x) in itertools.izip(results1[each_glitch][&#39;val&#39;],results2[each_glitch][&#39;val&#39;])])/num_valid_obs)
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>So that is almost all the fun for the raw glitch. Now, to call it, and interface with it, it&#39;s best to use the API. But if you can&#39;t, you can use the functions in logic_glitch.py.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="kn">from</span> <span class="nn">logic_glitch</span> <span class="kn">import</span> <span class="o">*</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">thisGlitch</span> <span class="o">=</span> <span class="n">SmartGlitcher</span><span class="p">(</span><span class="s">&#39;MS04311&#39;</span><span class="p">,</span><span class="s">&#39;AIRCEN01&#39;</span><span class="p">,</span><span class="s">&#39;2012-10-01 00:00:00&#39;</span><span class="p">,</span> <span class="s">&#39;2012-10-04 00:00:00&#39;</span><span class="p">,</span> <span class="mi">90</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>For example, the function above just gets AIRCEN01 from Oct 1 2012 to Oct 4 2012 at a 90 minute glitch. To output it, you can call the method .tocsv(csvfilename) on it. </p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">thisGlitch</span><span class="o">.</span><span class="n">tocsv</span><span class="p">(</span><span class="s">&#39;a_lovely_glitch.csv&#39;</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>This will generate HTML to the screen, and save the glitch to file. We can also use various interfaces, like hans_glitch.py (web), api_glitch.py (command line api), and catalina.py / igert.py to generate outputs for other people or have them do their own darn work!</p>
<p>And that&#39;s it for today&#39;s exploration of GLITCH.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
